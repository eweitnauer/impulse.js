...
var w = 960,    // visualization width in pixels
    ...
    scale = 15,  // 1 m in physic = x pixel in visualization
...
function init() {
  ...
  function createBody(x, y, rot, dynamic) {
    ...
    var shape = new Box2D.b2PolygonShape.AsBox(len/2, len/2/10);
...
function initVisualization() {
  ...
  function dragmove(d, i) {
    d.SetPosition(new Box2D.b2Vec2(Math.max(r, Math.min(w - r, d3.event.x))/scale,
